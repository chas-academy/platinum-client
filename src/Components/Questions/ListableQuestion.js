          ...
          <div className="width-35 mobile-width">
            <div className="width-100 frame center-content-row padding-1 mobile-center-content-column">
              ...
              <div className="mobile-space-around">
                <Button className="margin-tb-1 margin-r-1 button-opacity" size="large" color="teal" content="Edit" onClick={this.toggleEditQuestion} disabled={this.props.editingQuestionnaire} />
              ...
              trigger={ 
                <Button
                size="large"
                className="ui red basic button margin-tb-1 button-opacity"
