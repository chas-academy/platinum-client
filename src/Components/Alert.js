  ...
  render() {
    ...
    if (this.state.show) {
      return this.props.hideDismissButton ? (
        ...
        <Alert bsStyle={this.props.type} onDismiss={this.hideAlert}>
          {this.props.children}
        </Alert>
      );
    }
...
const AlertProcessRequest = props => <Alert>{props.children}</Alert>;

const AlertError = props => <Alert bsStyle="danger">{props.children}</Alert>;
