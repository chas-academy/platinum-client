  ...
  render() {
    return (
      <div className="students">
        <p>
          <ToggleButton onClick={this.toggleStudents} showStudents={this.state.showStudents} />
        </p>
        <hr />
...
jsx-a11y/no-noninteractive-element-interactions, react/no-array-index-key, no-use-before-define */
...
/* eslint-enable react/prop-types, jsx-a11y/click-events-have-key-events,
jsx-a11y/no-noninteractive-element-interactions, react/no-array-index-key, no-use-before-define */
